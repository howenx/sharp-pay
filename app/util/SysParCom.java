...
public class SysParCom {
    ...
    //订单支付描述的前缀
    public static String PAY_ORDER_DESC;
    //jd支付是否显示
    public static Boolean PAY_SHOW_JD;
    //微信支付是否显示
    ...
    public SysParCom(SkuService skuService, Configuration configuration) {
        ...
        PAY_ORDER_DESC=configuration.getString("pay.order.desc");
        PAY_SHOW_JD=configuration.getBoolean("pay.show.jd");
