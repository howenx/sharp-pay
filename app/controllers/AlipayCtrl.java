...
//            Logger.info("支付宝参数===>"+createLinkStringApp(map));
    ...
    private Map<String, String> getAlipayParams(Order order, AlipayTradeType alipayTradeType){
        ...
        String detail=SysParCom.PAY_ORDER_DESC+orderId;
        ...
        sParaTemp.put("notify_url", SysParCom.PAY_URL + "/client/alipay/pay/back");
        if(alipayTradeType==AlipayTradeType.DIRECT) {  //立即支付
            sParaTemp.put("return_url", SysParCom.PAY_URL + "/client/alipay/pay/front");
